...
class Quest extends Component {
    ...
    nextQuestionHandler = () => {
        ...
        if(typeof answers[Number(questionNumber)-1] === 'undefined'){
            ...
            if((this.state.answers[22] === document.getElementById('q23a2').value && (Number(questionNumber)===24)) || Number(answers[1])>2000 || Number(answers[1])<1988 ) {
                questionNumber = 27
            }
    ...
    prevQuestionHandler = () => {
        ...
        if(this.state.answers[22] === document.getElementById('q23a2').value && (Number(questionNumber) ===26)) {
            questionNumber=23
        }
    ...
    sendDate = () => {
        ...
        $.ajax({
            type: "POST",
            url: 'http://aplikacjewebowe.c0.pl/api.php',
            data: {
                answers
            }
        })
